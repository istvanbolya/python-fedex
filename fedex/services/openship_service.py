"""
openShip Service Module

This package contains the open shipping methods defined by Fedex's
OpenshipService WSDL file. Each is encapsulated in a class for easy access.
...
class FedexOpenShipmentRequest(FedexBaseService):
    """
    This class allows you to process (create)/modify a new FedEx open shipment. You will
    ...
    def __init__(self, config_obj, *args, **kwargs):
        ...
        """@ivar: Holds the RequestedShipment WSDL object including the shipper, recipient and shiptime."""
        self.Index = None
        """@ivar: Holds the Index number for the OpenShipment."""
        # Call the parent FedexBaseService class for basic setup work.
        super(FedexOpenShipmentRequest, self).__init__(
                self._config_obj, 'OpenshipService_v15.wsdl', *args, **kwargs)
    ...
    def send_modification_request(self):
        """
        This is used to modify the already created openshipment.
        """

        self.send_request(send_function=self._assemble_and_send_modification_request)

    def _assemble_and_send_modification_request(self):
        """
        Fires off the Fedex OpenShipment modification request.
        ...
        # Fire off the query.
        return self.client.service.modifyOpenShipment(
    ...
    def send_retrieve_shipment_request(self):
        """
        This is used to retrieve the current status of the shipment.
        """

        self.send_request(send_function=self._assemble_and_send_retrieve_shipment_request)

    def _assemble_and_send_retrieve_shipment_request(self):
        """
        Fires off the retrieve OpenShipment request.
        ...
        # Fire off the query.
        return self.client.service.retrieveOpenShipment(
            WebAuthenticationDetail=self.WebAuthenticationDetail,
            ClientDetail=self.ClientDetail,
            TransactionDetail=self.TransactionDetail,
            Version=self.VersionId,
    ...
    def send_validate_shipment_request(self):
        """
        This is used to validate the shipment.
        """

        self.send_request(send_function=self._assemble_and_send_validate_shipment_request)

    def _assemble_and_send_validate_shipment_request(self):
        """
        Fires off the validate OpenShipment request.
        ...
        # Fire off the query.
        return self.client.service.validateOpenShipment(
            WebAuthenticationDetail=self.WebAuthenticationDetail,
            ClientDetail=self.ClientDetail,
            TransactionDetail=self.TransactionDetail,
            Version=self.VersionId,
    ...
    def send_confirm_shipment_request(self):
        """
        This is used to confirm the shipment.
        """

        self.send_request(send_function=self._assemble_and_send_confirm_shipment_request)

    def _assemble_and_send_confirm_shipment_request(self):
        """
        Fires off the confirm OpenShipment request.
        ...
        # Fire off the query.
        return self.client.service.confirmOpenShipment(
            WebAuthenticationDetail=self.WebAuthenticationDetail,
            ClientDetail=self.ClientDetail,
            TransactionDetail=self.TransactionDetail,
            Version=self.VersionId,
    ...
    def _assemble_and_send_request(self):
        """
        Fires off the Fedex createOpenShipment request.
        ...
        # Fire off the query.
        return self.client.service.createOpenShipment(
            WebAuthenticationDetail=self.WebAuthenticationDetail,
            ClientDetail=self.ClientDetail,
            TransactionDetail=self.TransactionDetail,
            Version=self.VersionId,
